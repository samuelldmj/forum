  ...
  <div
    ...
    <div class="row align-items-center">
      <div class="col-md-8 mb-3 mb-sm-0">
        ...
        <p class="text-sm"><span class="op-6">Posted</span> <a class="text-black" href="#">54 minutes</a> <span
            class="op-6">ago by</span> <a class="text-black" href="#">DanielD</a></p>
        <div class="text-sm op-5"> <a class="text-black mr-2" href="#">Programming</a></div>
      </div>
      <div class="col-md-4 op-7">
        <div class="row text-center op-7">
  ...
  <div
    ...
    <div class="row align-items-center">
      <div class="col-md-8 mb-3 mb-sm-0">
        ...
        <p class="text-sm"><span class="op-6">Posted</span> <a class="text-black" href="#">32 minutes</a> <span
            class="op-6">ago by</span> <a class="text-black" href="#">AppStrapMaster</a></p>
        <div class="text-sm op-5"> <a class="text-black mr-2" href="#">Programming</a></div>
      </div>
      <div class="col-md-4 op-7">
        <div class="row text-center op-7">
  ...
  <div
    ...
    <div class="row align-items-center">
      <div class="col-md-8 mb-3 mb-sm-0">
        ...
        <p class="text-sm"><span class="op-6">Posted</span> <a class="text-black" href="#">29 minutes</a> <span
            class="op-6">ago by</span> <a class="text-black" href="#">Themelize.me</a></p>
        <div class="text-sm op-5"> <a class="text-black mr-2" href="#">Programming</a></div>
      </div>
      <div class="col-md-4 op-7">
        <div class="row text-center op-7">
